...
import (
	...
	resource "shulkermc.io/m/v2/internal/resource"
	"sigs.k8s.io/controller-runtime/pkg/client"
	"sigs.k8s.io/controller-runtime/pkg/controller/controllerutil"
)

func ReconcileWithResourceBuilders(client client.Client, ctx context.Context, builders []resource.ResourceBuilder, dirtyBuilders []resource.ResourceBuilder) error {
