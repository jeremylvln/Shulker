...
public class V1alpha1MinecraftClusterStatusConditions {
  ...
  public V1alpha1MinecraftClusterStatusConditions lastTransitionTime(OffsetDateTime lastTransitionTime) {
  ...
  **/
  ...
  public V1alpha1MinecraftClusterStatusConditions message(String message) {
  ...
  **/
  ...
  public V1alpha1MinecraftClusterStatusConditions observedGeneration(Long observedGeneration) {
  ...
  **/
  ...
  public V1alpha1MinecraftClusterStatusConditions reason(String reason) {
  ...
  **/
  ...
  public V1alpha1MinecraftClusterStatusConditions status(StatusEnum status) {
  ...
  **/
  ...
  public V1alpha1MinecraftClusterStatusConditions type(String type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1MinecraftClusterStatusConditions v1alpha1MinecraftClusterStatusConditions = (V1alpha1MinecraftClusterStatusConditions) o;
    return Objects.equals(this.lastTransitionTime, v1alpha1MinecraftClusterStatusConditions.lastTransitionTime) &&
        Objects.equals(this.message, v1alpha1MinecraftClusterStatusConditions.message) &&
        Objects.equals(this.observedGeneration, v1alpha1MinecraftClusterStatusConditions.observedGeneration) &&
        Objects.equals(this.reason, v1alpha1MinecraftClusterStatusConditions.reason) &&
        Objects.equals(this.status, v1alpha1MinecraftClusterStatusConditions.status) &&
        Objects.equals(this.type, v1alpha1MinecraftClusterStatusConditions.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1MinecraftClusterStatusConditions {\n");
