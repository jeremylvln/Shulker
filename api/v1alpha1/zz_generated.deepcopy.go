...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MinecraftClusterPool) DeepCopyInto(out *MinecraftClusterPool) {
	*out = *in
	if in.Servers != nil {
		in, out := &in.Servers, &out.Servers
		*out = make([]MinecraftClusterPoolServerEntry, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MinecraftClusterPool.
func (in *MinecraftClusterPool) DeepCopy() *MinecraftClusterPool {
	if in == nil {
		return nil
	}
	out := new(MinecraftClusterPool)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MinecraftClusterPoolServerEntry) DeepCopyInto(out *MinecraftClusterPoolServerEntry) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MinecraftClusterPoolServerEntry.
func (in *MinecraftClusterPoolServerEntry) DeepCopy() *MinecraftClusterPoolServerEntry {
	if in == nil {
		return nil
	}
	out := new(MinecraftClusterPoolServerEntry)
	in.DeepCopyInto(out)
	return out
}
