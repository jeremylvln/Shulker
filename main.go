...
import (
	...
	"github.com/IamBlueSlime/Shulker/controllers"
...
func main() {
	...
	rs, err := resource.NewResourceStore("store")
	if err != nil {
		setupLog.Error(err, "Unable to create resource store")
		os.Exit(1)
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "087b83f2.shulkermc.io",
	})
	if err != nil {
	...
	if err = (&controllers.TemplateResourceReconciler{
		Client:        mgr.GetClient(),
		Scheme:        mgr.GetScheme(),
		ResourceStore: &rs,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "TemplateResource")
		os.Exit(1)
	}
