...
To cleanup this tutorial more easily, create a temporary dedicated namespace:

```bash
$ kubectl create ns shulker-tutorial
```

After this tutorial, you'll be able to delete it completly with all its contained resources:
