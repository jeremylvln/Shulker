...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("apache-commons-io", "commons-io:commons-io:2.17.0")
            ...
            library("grpc-common-protos", "com.google.api.grpc:proto-google-common-protos:2.48.0")
            ...
            library("protobuf", "com.google.protobuf:protobuf-java:3.25.5")
