...
$CODECOV -t $CODECOV_TOKEN -F shulker-agent -f .\dist\java\packages\shulker-agent\test-results\test\binary -f .\dist\java\packages\shulker-agent\jacoco\test.exec -f .\dist\java\packages\shulker-agent\reports\tests\test -f .\dist\java\packages\shulker-agent\test-results\test
$CODECOV -t $CODECOV_TOKEN -F shulker-agent-api -f .\dist\java\packages\shulker-agent-api\test-results\test\binary -f .\dist\java\packages\shulker-agent-api\jacoco\test.exec -f .\dist\java\packages\shulker-agent-api\reports\tests\test -f .\dist\java\packages\shulker-agent-api\test-results\test
