...
use crate::resources::{resourceref_resolver::ResourceRefResolver, ResourceRefError};
...
mod tests {
    ...
    use shulker_crds::{
        resourceref::{ResourceRefSpec, LocationResourceRefSpec}, schemas::ImageOverrideSpec,
