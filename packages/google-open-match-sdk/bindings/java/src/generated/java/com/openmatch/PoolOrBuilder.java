...
public interface PoolOrBuilder extends
   ...
   */
  java.util.List<com.openmatch.DoubleRangeFilter> 
   ...
   * <code>repeated .openmatch.DoubleRangeFilter double_range_filters = 2 [json_name = "doubleRangeFilters"];</code>
   */
  com.openmatch.DoubleRangeFilter getDoubleRangeFilters(int index);
  /**
   * <pre>
   * Set of Filters indicating the filtering criteria. Selected tickets must
   * match every Filter.
   ...
   * <code>repeated .openmatch.DoubleRangeFilter double_range_filters = 2 [json_name = "doubleRangeFilters"];</code>
   */
  java.util.List<? extends com.openmatch.DoubleRangeFilterOrBuilder> 
   ...
   * <code>repeated .openmatch.DoubleRangeFilter double_range_filters = 2 [json_name = "doubleRangeFilters"];</code>
   */
  com.openmatch.DoubleRangeFilterOrBuilder getDoubleRangeFiltersOrBuilder(
      int index);

  /**
   * <code>repeated .openmatch.StringEqualsFilter string_equals_filters = 4 [json_name = "stringEqualsFilters"];</code>
   */
  java.util.List<com.openmatch.StringEqualsFilter> 
      getStringEqualsFiltersList();
  /**
   * <code>repeated .openmatch.StringEqualsFilter string_equals_filters = 4 [json_name = "stringEqualsFilters"];</code>
   */
  com.openmatch.StringEqualsFilter getStringEqualsFilters(int index);
  /**
   * <code>repeated .openmatch.StringEqualsFilter string_equals_filters = 4 [json_name = "stringEqualsFilters"];</code>
   */
   ...
   * <code>repeated .openmatch.StringEqualsFilter string_equals_filters = 4 [json_name = "stringEqualsFilters"];</code>
   */
  java.util.List<? extends com.openmatch.StringEqualsFilterOrBuilder> 
      getStringEqualsFiltersOrBuilderList();
  /**
   * <code>repeated .openmatch.StringEqualsFilter string_equals_filters = 4 [json_name = "stringEqualsFilters"];</code>
   */
  com.openmatch.StringEqualsFilterOrBuilder getStringEqualsFiltersOrBuilder(
      int index);

  /**
   * <code>repeated .openmatch.TagPresentFilter tag_present_filters = 5 [json_name = "tagPresentFilters"];</code>
   */
  java.util.List<com.openmatch.TagPresentFilter> 
      getTagPresentFiltersList();
  /**
   * <code>repeated .openmatch.TagPresentFilter tag_present_filters = 5 [json_name = "tagPresentFilters"];</code>
   */
  com.openmatch.TagPresentFilter getTagPresentFilters(int index);
  /**
   * <code>repeated .openmatch.TagPresentFilter tag_present_filters = 5 [json_name = "tagPresentFilters"];</code>
   */
   ...
   * <code>repeated .openmatch.TagPresentFilter tag_present_filters = 5 [json_name = "tagPresentFilters"];</code>
   */
  java.util.List<? extends com.openmatch.TagPresentFilterOrBuilder> 
      getTagPresentFiltersOrBuilderList();
  /**
   * <code>repeated .openmatch.TagPresentFilter tag_present_filters = 5 [json_name = "tagPresentFilters"];</code>
   */
  com.openmatch.TagPresentFilterOrBuilder getTagPresentFiltersOrBuilder(
      int index);
