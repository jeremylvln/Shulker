...
public final class MatchFunctionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<dev.openmatch.RunRequest,
      dev.openmatch.RunResponse> getRunMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Run",
      requestType = dev.openmatch.RunRequest.class,
      responseType = dev.openmatch.RunResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<dev.openmatch.RunRequest,
      dev.openmatch.RunResponse> getRunMethod() {
    io.grpc.MethodDescriptor<dev.openmatch.RunRequest, dev.openmatch.RunResponse> getRunMethod;
      ...
      synchronized (MatchFunctionGrpc.class) {
        if ((getRunMethod = MatchFunctionGrpc.getRunMethod) == null) {
          MatchFunctionGrpc.getRunMethod = getRunMethod =
              io.grpc.MethodDescriptor.<dev.openmatch.RunRequest, dev.openmatch.RunResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Run"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.openmatch.RunRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.openmatch.RunResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void run(dev.openmatch.RunRequest request,
        io.grpc.stub.StreamObserver<dev.openmatch.RunResponse> responseObserver) {
  ...
  public static final class MatchFunctionStub
     ...
     * </pre>
     */
    public void run(dev.openmatch.RunRequest request,
        io.grpc.stub.StreamObserver<dev.openmatch.RunResponse> responseObserver) {
  ...
  public static final class MatchFunctionBlockingStub
     ...
     * </pre>
     */
    public java.util.Iterator<dev.openmatch.RunResponse> run(
        dev.openmatch.RunRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RUN:
          serviceImpl.run((dev.openmatch.RunRequest) request,
              (io.grpc.stub.StreamObserver<dev.openmatch.RunResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              dev.openmatch.RunRequest,
              dev.openmatch.RunResponse>(
  ...
  private static abstract class MatchFunctionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return dev.openmatch.MatchFunctionProto.getDescriptor();
    }
