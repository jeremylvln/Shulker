...
public final class EvaluatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.openmatch.EvaluateRequest,
      com.openmatch.EvaluateResponse> getEvaluateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Evaluate",
      requestType = com.openmatch.EvaluateRequest.class,
      responseType = com.openmatch.EvaluateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.openmatch.EvaluateRequest,
      com.openmatch.EvaluateResponse> getEvaluateMethod() {
    io.grpc.MethodDescriptor<com.openmatch.EvaluateRequest, com.openmatch.EvaluateResponse> getEvaluateMethod;
      ...
      synchronized (EvaluatorGrpc.class) {
        if ((getEvaluateMethod = EvaluatorGrpc.getEvaluateMethod) == null) {
          EvaluatorGrpc.getEvaluateMethod = getEvaluateMethod =
              io.grpc.MethodDescriptor.<com.openmatch.EvaluateRequest, com.openmatch.EvaluateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Evaluate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.openmatch.EvaluateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.openmatch.EvaluateResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.openmatch.EvaluateRequest> evaluate(
        io.grpc.stub.StreamObserver<com.openmatch.EvaluateResponse> responseObserver) {
  ...
  public static final class EvaluatorStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.openmatch.EvaluateRequest> evaluate(
        io.grpc.stub.StreamObserver<com.openmatch.EvaluateResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.openmatch.EvaluateRequest,
              com.openmatch.EvaluateResponse>(
  ...
  private static abstract class EvaluatorBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.openmatch.EvaluatorProto.getDescriptor();
    }
