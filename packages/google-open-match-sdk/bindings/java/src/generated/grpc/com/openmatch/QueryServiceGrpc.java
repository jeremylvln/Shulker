...
public final class QueryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.openmatch.QueryTicketsRequest,
      com.openmatch.QueryTicketsResponse> getQueryTicketsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryTickets",
      requestType = com.openmatch.QueryTicketsRequest.class,
      responseType = com.openmatch.QueryTicketsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.openmatch.QueryTicketsRequest,
      com.openmatch.QueryTicketsResponse> getQueryTicketsMethod() {
    io.grpc.MethodDescriptor<com.openmatch.QueryTicketsRequest, com.openmatch.QueryTicketsResponse> getQueryTicketsMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryTicketsMethod = QueryServiceGrpc.getQueryTicketsMethod) == null) {
          QueryServiceGrpc.getQueryTicketsMethod = getQueryTicketsMethod =
              io.grpc.MethodDescriptor.<com.openmatch.QueryTicketsRequest, com.openmatch.QueryTicketsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "QueryTickets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.openmatch.QueryTicketsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.openmatch.QueryTicketsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.openmatch.QueryTicketIdsRequest,
      com.openmatch.QueryTicketIdsResponse> getQueryTicketIdsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryTicketIds",
      requestType = com.openmatch.QueryTicketIdsRequest.class,
      responseType = com.openmatch.QueryTicketIdsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.openmatch.QueryTicketIdsRequest,
      com.openmatch.QueryTicketIdsResponse> getQueryTicketIdsMethod() {
    io.grpc.MethodDescriptor<com.openmatch.QueryTicketIdsRequest, com.openmatch.QueryTicketIdsResponse> getQueryTicketIdsMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryTicketIdsMethod = QueryServiceGrpc.getQueryTicketIdsMethod) == null) {
          QueryServiceGrpc.getQueryTicketIdsMethod = getQueryTicketIdsMethod =
              io.grpc.MethodDescriptor.<com.openmatch.QueryTicketIdsRequest, com.openmatch.QueryTicketIdsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "QueryTicketIds"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.openmatch.QueryTicketIdsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.openmatch.QueryTicketIdsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.openmatch.QueryBackfillsRequest,
      com.openmatch.QueryBackfillsResponse> getQueryBackfillsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryBackfills",
      requestType = com.openmatch.QueryBackfillsRequest.class,
      responseType = com.openmatch.QueryBackfillsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.openmatch.QueryBackfillsRequest,
      com.openmatch.QueryBackfillsResponse> getQueryBackfillsMethod() {
    io.grpc.MethodDescriptor<com.openmatch.QueryBackfillsRequest, com.openmatch.QueryBackfillsResponse> getQueryBackfillsMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryBackfillsMethod = QueryServiceGrpc.getQueryBackfillsMethod) == null) {
          QueryServiceGrpc.getQueryBackfillsMethod = getQueryBackfillsMethod =
              io.grpc.MethodDescriptor.<com.openmatch.QueryBackfillsRequest, com.openmatch.QueryBackfillsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "QueryBackfills"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.openmatch.QueryBackfillsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.openmatch.QueryBackfillsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void queryTickets(com.openmatch.QueryTicketsRequest request,
        io.grpc.stub.StreamObserver<com.openmatch.QueryTicketsResponse> responseObserver) {
     ...
     * </pre>
     */
    default void queryTicketIds(com.openmatch.QueryTicketIdsRequest request,
        io.grpc.stub.StreamObserver<com.openmatch.QueryTicketIdsResponse> responseObserver) {
     ...
     * </pre>
     */
    default void queryBackfills(com.openmatch.QueryBackfillsRequest request,
        io.grpc.stub.StreamObserver<com.openmatch.QueryBackfillsResponse> responseObserver) {
  ...
  public static final class QueryServiceStub
     ...
     * </pre>
     */
    public void queryTickets(com.openmatch.QueryTicketsRequest request,
        io.grpc.stub.StreamObserver<com.openmatch.QueryTicketsResponse> responseObserver) {
     ...
     * </pre>
     */
    public void queryTicketIds(com.openmatch.QueryTicketIdsRequest request,
        io.grpc.stub.StreamObserver<com.openmatch.QueryTicketIdsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
     ...
     * </pre>
     */
    public void queryBackfills(com.openmatch.QueryBackfillsRequest request,
        io.grpc.stub.StreamObserver<com.openmatch.QueryBackfillsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
  ...
  public static final class QueryServiceBlockingStub
     ...
     * </pre>
     */
    public java.util.Iterator<com.openmatch.QueryTicketsResponse> queryTickets(
        com.openmatch.QueryTicketsRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.openmatch.QueryTicketIdsResponse> queryTicketIds(
        com.openmatch.QueryTicketIdsRequest request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
     ...
     * </pre>
     */
    public java.util.Iterator<com.openmatch.QueryBackfillsResponse> queryBackfills(
        com.openmatch.QueryBackfillsRequest request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QUERY_TICKETS:
          serviceImpl.queryTickets((com.openmatch.QueryTicketsRequest) request,
              (io.grpc.stub.StreamObserver<com.openmatch.QueryTicketsResponse>) responseObserver);
          break;
        case METHODID_QUERY_TICKET_IDS:
          serviceImpl.queryTicketIds((com.openmatch.QueryTicketIdsRequest) request,
              (io.grpc.stub.StreamObserver<com.openmatch.QueryTicketIdsResponse>) responseObserver);
          break;
        case METHODID_QUERY_BACKFILLS:
          serviceImpl.queryBackfills((com.openmatch.QueryBackfillsRequest) request,
              (io.grpc.stub.StreamObserver<com.openmatch.QueryBackfillsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.openmatch.QueryTicketsRequest,
              com.openmatch.QueryTicketsResponse>(
                service, METHODID_QUERY_TICKETS)))
        .addMethod(
          getQueryTicketIdsMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.openmatch.QueryTicketIdsRequest,
              com.openmatch.QueryTicketIdsResponse>(
                service, METHODID_QUERY_TICKET_IDS)))
        .addMethod(
          getQueryBackfillsMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.openmatch.QueryBackfillsRequest,
              com.openmatch.QueryBackfillsResponse>(
  ...
  private static abstract class QueryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.openmatch.QueryProto.getDescriptor();
    }
